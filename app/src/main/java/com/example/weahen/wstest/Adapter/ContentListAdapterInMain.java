...
public class ContentListAdapterInMain extends BaseAdapter implements View.OnClickListener {
    ...
    public ContentListAdapterInMain(Context context, List<Content> navDrawerItems, Activity activity) {
