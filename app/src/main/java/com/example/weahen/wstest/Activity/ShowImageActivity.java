...
public class ShowImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("ws","--->ShowImageActivity onCreate");
        findId();
        init();
        Listener();
    }
...
//        button = (Button) findViewById(R.id.button);
    ...
    private void init() {
        ...
        if (imageInfoObj == null) {
            Log.e("ws","--->imageInfoObj==null");
        }
        if (imageWidgetInfoObj == null) {
            Log.e("ws","-->imageWidgetInfoObj==null");
        }
...
//        });
    ...
    protected void onResume() {
        super.onResume();
        Log.e("ws","--->ShowImageActivity onResume");
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.e("ws","--->ShowImageActivity onPause");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Log.e("ws","--->ShowImageActivity onDestroy");
    }
